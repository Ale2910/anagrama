...
// Configurando a mudança dos radios
elements.difficulty[0].onchange = clearCongrats
elements.difficulty[1].onchange = clearCongrats
elements.difficulty[2].onchange = clearCongrats
...
function clearCongrats (){
    ...
    // Tirando a palavra 
    elements.word.innerHTML = '<strong> (esperando gerar) </strong>'

    // Limpando o input de verificação
...
const words = {
    ...
    ez: [
        ...
        'gerar', 'moto', 'azul', 'correr', 'pedra', 'avião', 'céu', 
        'bola', 'mar', 'pato', 'dia', 'gato', 'amor', 'juntos', 
        'pasta', 'dentes', 'amor', 'fogo'
    ],

    medium: [
       'cadeira', 'esmalte', 'palavra', 'tablet', 'teclado',
       'caminhar', 'lâmpada', 'caminhão', 'celular','ganhar', 
       'perder', 'mochila', 'imprimir', 'concreto', 'cimento',
       'headset', 'código', 'almofadas', 'tablet', 'toalha',
       'gavião', 'paredes', 'clínica', 'doença', 'morangos', 
       'música', 'corrida', 'cavalos', 'gelatina', 'maionese',
       'encarar', 'felicidade', 'chirivia', 'pediatra',
       'sanduíche', 
    ],
    ...
    hard: [
        ...
        'carregador', 'smartphone', 'headphones', 'travesseiro', 
        'pirulito', 'embalagens'
    ]
}
